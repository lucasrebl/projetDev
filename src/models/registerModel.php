...
if (!function_exists('addUser')) {
    function addUser($username_, $email_, $hashed_passwordUser, $age_)
    {
        try {
            ...
            if ($stmt->fetchColumn() > 0) {
                ...
                $stmt2 = $dsn->prepare("INSERT INTO user (username, email, passwordUser, age) VALUES (:username, :email, :passwordUser, :age) ");
